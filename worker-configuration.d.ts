/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a75087ad4c595d28c96bee0016f7a90a)
// Runtime types generated with workerd@1.20260722.1 2026-07-28 nodejs_compat
interface __BaseEnv_Env {
	OCI_REGION: "eu-stockholm-1";
	STACK_LABEL: "minecraft-server";
	ERROR_COOLDOWN_SECONDS: "21600";
	LEASE_SECONDS: "600";
	JOB_POLL_SECONDS: "120";
	TRANSIENT_RETRY_SECONDS: "300";
	CREATE_COOLDOWN_SECONDS: "1200";
	OCI_TENANCY_OCID: string;
	OCI_USER_OCID: string;
	OCI_KEY_FINGERPRINT: string;
	OCI_PRIVATE_KEY: string;
	OCI_STACK_OCID: string;
	DISCORD_WEBHOOK_URL: string;
	DISCORD_SUCCESS_USER_ID: string;
	ADMIN_TOKEN: string;
	DEPLOYMENT_COORDINATOR: DurableObjectNamespace<import("./src/index").DeploymentCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DeploymentCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OCI_REGION" | "STACK_LABEL" | "ERROR_COOLDOWN_SECONDS" | "LEASE_SECONDS" | "JOB_POLL_SECONDS" | "TRANSIENT_RETRY_SECONDS" | "CREATE_COOLDOWN_SECONDS" | "OCI_TENANCY_OCID" | "OCI_USER_OCID" | "OCI_KEY_FINGERPRINT" | "OCI_PRIVATE_KEY" | "OCI_STACK_OCID" | "DISCORD_WEBHOOK_URL" | "DISCORD_SUCCESS_USER_ID" | "ADMIN_TOKEN">> {}
}
